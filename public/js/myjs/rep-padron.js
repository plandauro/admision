      ...
      "columns":[
          ...
          },
          {
            ...
            "render": function(data, type, row) {
                return '<center><a href="'+$urlbase+'/pdf/padron/'+row.idproceso+'/'+row.id+'" style="color:#E10F16;font-size:20px" title="Descargar padron por escuela de '+row.descripcion+'"><span class="fa fa-download"></span></a></center>'
            },
            "width": 50
          }
      ],
