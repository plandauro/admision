...
@section('title', 'RESULTADOS DEL EXAMEN GENERAL')
@section('content')
@parent
...
<div class="">
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Reporte de Examen General Contabilidad y Finanzas turno tarde</h2>
          <br> <br>
          <div class="col-md-2">
            <button><a href="{{ url('llenar-respuestas-2020-2-CFT') }}">Proceso de Calificación</a></button>
          </div>
          ...
          <ul class="nav navbar-right panel_toolbox">
            ...
            <li style="margin-right: 15px">
              <select style="width: 200px" id="tipobusqueda" onchange="cargarCombo()" class="form-control" name="" id="">
                <option value="0">Postulantes Examen General</option>
...
<script src="{{ asset('js/myjs/rep-postulante-calificacion-2020-2-CFT.js') }}"></script>
<script>
  $(document).ready(function() {
        $('#ididentificacion').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: 'rep-calificacion-2020-2-CFM',
