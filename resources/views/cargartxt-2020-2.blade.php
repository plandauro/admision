...
<div class="">
  <div class="page-title">
    <div class="title_left">
      <h3>Cargar Información con DLM │ Examen General</h3>
    </div>
    ...
    <div class="col-md-12">
      <div id="verificar" class="x_panel">
        ...
        <div id="principal" class="x_content">
          <div class="row">
            <div class="col-md-6">
              <h2>Cargue los resultados de DLM - Examen General:</h2>
