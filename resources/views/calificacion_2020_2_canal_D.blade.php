        ...
        <div class="x_panel">
          <div class="x_title">
            <h2>Reporte de Calificacion Canal D</h2>
                        <br>     <br>                   
            <div class="col-md-2">
			<button><a  href="{{ url('llenar-respuestas-2020-2_canal_D') }}">Proceso de Calificación</a></button>
		</div>
...
@section('js')
  ...
  <script src="{{ asset('js/myjs/rep-postulante-calificacion-2020-2_canal_D.js') }}"></script>
  <script>
