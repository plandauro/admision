...
@section('title', 'REPORTE DE CALIFICACION SIMULACRO ASISTENCIA - CANALES')
...
<div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-7 col-xs-12">
                <input id="canallitho"  onkeyup="mayus(this);" type="text" class="form-control" placeholder="">
              </div>
            </div>
...
@section('js')
  ...
  <script src="{{ asset('js/myjs/rep-postulante-calificacion-Simulacro-Canales.js') }}"></script>
@endsection