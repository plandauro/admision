...
@section('title', 'RESULTADOS DEL EXAMEN ESPECIAL 2020-II')
@section('content')
@parent
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          ...
          <br> <br>
          <div class="col-md-2">
            <button><a href="{{ url('llenar-respuestas-2020-2_especial') }}">Proceso de Calificación</a></button>
          </div>
...
<script src="{{ asset('js/myjs/rep-postulante-calificacion-2020-2_especial.js') }}"></script>
<script>
