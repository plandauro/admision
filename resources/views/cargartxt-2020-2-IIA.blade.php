...
<div class="">
  <div class="page-title">
    <div class="title_left">
      <h3>Cargar Información con DLM │ Ingeniería en Industrias Alimentarias 2020-II</h3>
    </div>
    ...
    <div class="col-md-12">
      <div id="verificar" class="x_panel">
        ...
        <div id="principal" class="x_content">
          <div class="row">
            <div class="col-md-6">
              <h2>Cargue los DLM - Ingeniería en Industrias Alimentarias 2020-II:</h2>
...
<script>
  ...
  $(document).on("submit", ".formarchivo", function(e) {
    ...
    if (nombreform == "f_cargar_datos_usuarios") {
      var miurl = "cargar-txt-2020-2-IIA";
...
<script>
  ...
  $(document).on("submit", ".formarchivo1", function(e) {
    ...
    //if(nombreform=="f_subir_imagen" ){ var miurl="subir_imagen_usuario";  var divresul="notificacion_resul_fci"}
    if (nombreform == "f_cargar_datos_usuarios1") {
      var miurl = "cargar-txt1-2020-2-IIA";
      var divresul = "notificacion_resul_fcdu"
    }
...
<script>
  ...
  $(document).on("submit", ".formarchivo2", function(e) {
    ...
    //if(nombreform=="f_subir_imagen" ){ var miurl="subir_imagen_usuario";  var divresul="notificacion_resul_fci"}
    if (nombreform == "f_cargar_datos_usuarios2") {
      var miurl = "cargar-txt2-2020-2-IIA";
      var divresul = "notificacion_resul_fcdu"
    }
...
<script>
  ...
  $(document).on("submit", ".formarchivo3", function(e) {
    ...
    //if(nombreform=="f_subir_imagen" ){ var miurl="subir_imagen_usuario";  var divresul="notificacion_resul_fci"}
    if (nombreform == "f_cargar_datos_usuarios3") {
      var miurl = "cargar-txt3-2020-2-IIA";
      var divresul = "notificacion_resul_fcdu"
    }
