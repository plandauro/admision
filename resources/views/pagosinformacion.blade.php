          ...
          <div class="row">
            ...
            <div style="padding-right: 100px;margin-top: 0px;" class="col-xs-12 col-md-12">
              ...
              <p style="font-weight:bold; aling:center;">       DEPÓSITOS/PAGOS</p> 
                      <div class="prueba2">   <p style="font-weight:bold; aling:center;   width: 600px;   font-size: 15px; ">      AGENTE: 25-122-01-{{ $dni }} (PAGO PREFERENCIAL)</p>    
     
             </div>
                   
                    <div class="prueba2">   <p style="font-weight:bold; aling:center;">      VENTANILLA : 05-122-01-{{ $dni }}</p>       
