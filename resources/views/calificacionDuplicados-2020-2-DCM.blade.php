      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <h2>Reporte de Calificacion Duplicados │ EXAMEN GENERAL DERECHO Y CIENCIAS POLÍTICAS TURNO MAÑANA</h2>
...
@section('js')
  ...
  <script src="{{ asset('js/myjs/rep-postulante-calificacion-Duplicados-2020-2-DCM.js') }}"></script>
@endsection