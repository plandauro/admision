...
@section('title', 'RESULTADOS DEL EXAMEN DEL GENERAL 2018-II')
@section('content')
  @parent
        ...
        <div class="x_panel">
          <div class="x_title">
            <h2>Reporte de Calificacion</h2>
                        <br>     <br>                   
            <div class="col-md-2">
			<button><a  href="{{ url('llenar-respuestas') }}">Proceso de Calificación</a></button>
		</div>
...
@section('js')
  ...
  <script src="{{ asset('js/myjs/rep-postulante-calificacion.js') }}"></script>
  <script>
