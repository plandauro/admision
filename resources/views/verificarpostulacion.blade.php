      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div id="verificar" class="x_panel">
                           ...
                           @else
                            >
                             ...
                             <option value="{{ $departamento->iddepa }}" 
                                 ...
                                 @if($departamento->iddepa==Auth::user()->iddepartamentonacimiento)
                                        selected @endif>
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                      ...
                      <input type="number" value="{{ date ('Y') }}" min="{{ date ('Y') -70 }}" max="{{ date ('Y') }}" class="form-control" name="anotermino" id="anotermino">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="panel-body">
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select name="idtarifa" id="idtarifa" class="form-control">
                      ...
                      <option value="{{$tarifa->idtarifa}}">{{$tarifa->descripcion}}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select name="idescuela" id="idescuela" class="form-control">
                      ...
                      <option value="{{$escuela->idescuela}}">{{$escuela->descripcion}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="panel-body">
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select name="medioseentero" id="medioseentero" class="form-control">
                      <option value="0">(Seleccionar)</option>
                      @foreach($encuesta1 as $encuesta1x)
                      <option value="{{$encuesta1x->id}}">{{$encuesta1x->descripcion}}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select name="dondesepreparo" id="dondesepreparo" class="form-control">
                      <option value="0">(Seleccionar)</option>
                      @foreach($encuesta2 as $encuesta2x)
                      <option value="{{$encuesta2x->id}}">{{$encuesta2x->descripcion}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
          ...
          <div id="principal"  class="x_content">
            <div class="mypanel">
              <div  class ="message">
                <img style="width: 70px" src="{{ asset('images/logochico.png') }}">
          ...
          <div id="loading" style="display: none;" class="x_content">
            <div>
              <div class ="loading">
                <img style="width: 70px" src="{{ asset('images/logochico.png') }}"> <br>
                <img style="width: 70px" src="{{ asset('images/loading.gif') }}">
              </div>
            </div>
          </div>
          <div id="verificado" style="display: none;" class="x_content">
            <div class="mypanel">
              <table style="margin:18px;">
                <tr>
                  <td>
                    <img style="width: 100px" id="v-imgPostulante" src="{{ asset('images/user.png') }}">
                  </td>
                  <td id="v-datos">                      
                  </td>
                </tr>
...
@section('js')
<script src="{{ asset('js/myjs/verificarpostulacion.js') }}"></script>
