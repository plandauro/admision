  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Cargar Información con DLM │ Examen GENERAL CONTABILIDAD Y FINANZAS TURNO MAÑANA 2020-II</h3>
      </div>
  ...
  function fileValidation(){
    ...
    $(document).on("submit",".formarchivo",function(e){
  	fileValidation();
        ...
        if(nombreform=="f_cargar_datos_usuarios" ){ var miurl="cargar-txt-2020-2-CFM";  var divresul="notificacion_resul_fcdu"}
  ...
  function fileValidation2(){
    ...
    $(document).on("submit",".formarchivo1",function(e){
  	fileValidation2();
        ...
        //if(nombreform=="f_subir_imagen" ){ var miurl="subir_imagen_usuario";  var divresul="notificacion_resul_fci"}
        if(nombreform=="f_cargar_datos_usuarios1" ){ var miurl="cargar-txt1-2020-2-CFM";  var divresul="notificacion_resul_fcdu"}
  ...
  function fileValidation3(){
    ...
    $(document).on("submit",".formarchivo2",function(e){
  	fileValidation3();
        ...
        //if(nombreform=="f_subir_imagen" ){ var miurl="subir_imagen_usuario";  var divresul="notificacion_resul_fci"}
        if(nombreform=="f_cargar_datos_usuarios2" ){ var miurl="cargar-txt2-2020-2-CFM";  var divresul="notificacion_resul_fcdu"}
...
function fileValidation4(){
    ...
    $(document).on("submit",".formarchivo3",function(e){
  	fileValidation4();
        ...
        //if(nombreform=="f_subir_imagen" ){ var miurl="subir_imagen_usuario";  var divresul="notificacion_resul_fci"}
        if(nombreform=="f_cargar_datos_usuarios3" ){ var miurl="cargar-txt3-2020-2-CFM";  var divresul="notificacion_resul_fcdu"}
