		...
		<tr>
			<td style="width: 200px;">
				<img style="margin:0px; padding: 0px;" 
					width="100px" src="{{ asset('images/logo.png') }}">
			</td>
	...
	<table class="table">
		<tr>
			...
			<td style="width: 360px">
				{{ str_pad($postulacion->nroPostulante, 6, "0", STR_PAD_LEFT) }}
				<strong style="margin-left: 30px;">DOC. IDEN.:</strong><span> {{ $postulante->dni }} </span>
			...
			<td style="width: 100px; padding: 0px;" rowspan="5">
				<div class="foto">
					<img id="img-foto" src="{{ asset($postulante->foto) }}" alt="">
				</div>
			</td>
		</tr>
		<tr>
			...
			<td style="width: 10px;">:</td>
			<td style="width: 360px">{{ strtoupper($postulante->apepaterno) }} {{ strtoupper($postulante->apematerno) }} {{ strtoupper($postulante->nombre) }}</td>
		</tr>
		<tr>
			<td style="width: 150px;""><strong>MODALIDAD POSTULACIÓN</strong></td>
			<td style="width: 10px;">:</td>
			<td style="width: 360px">{{ strtoupper($postulacion->modalidad) }}</td>
		</tr>
		<tr>
			<td style="width: 150px;""><strong>ESCUELA PROFESIONAL</strong></td>
			<td style="width: 10px;">:</td>
			<td style="width: 360px">{{ strtoupper($postulacion->escuela) }}</td>
		</tr>
		<tr>
			<td colspan="3">
			<br>
