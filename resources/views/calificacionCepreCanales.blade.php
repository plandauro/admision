...
@section('title', 'REPORTE DE CALIFICACION CEPRE ASISTENCIA - CANALES')
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <h2>Reporte de CEPRE asistencia - Canales</h2>
...
<div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-7 col-xs-12">
                <input id="canallitho" type="text" onkeyup="mayus(this);" class="form-control" placeholder="">
              </div>
            </div>
...
@section('js')
  ...
  <script src="{{ asset('js/myjs/rep-postulante-calificacion-Cepre-Canales.js') }}"></script>
@endsection