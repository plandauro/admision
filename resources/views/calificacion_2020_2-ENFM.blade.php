...
<div class="">
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Reporte de Examen General Enfermería turno mañana</h2>
          <br> <br>
          <div class="col-md-2">
            <button><a href="{{ url('llenar-respuestas-2020-2-ENFM') }}">Proceso de Calificación</a></button>
          </div>
...
<script src="{{ asset('js/myjs/rep-postulante-calificacion-2020-2-ENFM.js') }}"></script>
<script>
