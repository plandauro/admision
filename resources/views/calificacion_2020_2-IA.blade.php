        ...
        <div class="x_panel">
          <div class="x_title">
            <h2>Reporte de Calificacion Ingeniería Agrónoma 2020-II</h2>
                        <br>     <br>                   
            <div class="col-md-2">
			<button><a  href="{{ url('llenar-respuestas-2020-2-IA') }}">Proceso de Calificación</a></button>
		</div>
...
@section('js')
  ...
  <script src="{{ asset('js/myjs/rep-postulante-calificacion-2020-2-IA.js') }}"></script>
  <script>
