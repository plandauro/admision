...
@section('title', 'RESULTADOS DEL EXAMEN DEL CEPRE INTENSIVO 2020-I')
        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <h2>Reporte de Calificacion CEPRE</h2>
                        <br>     <br>                   
            <div class="col-md-2">
			<button><a  href="{{ url('llenar-respuestas-cepre') }}">Proceso de Calificación</a></button>
		</div>
...
@section('js')
  ...
  <script src="{{ asset('js/myjs/rep-postulante-calificacion-Cepre.js') }}"></script>
  <script>
