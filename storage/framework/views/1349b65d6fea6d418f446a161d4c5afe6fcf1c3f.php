      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <div id="wizard" class="form_wizard wizard_horizontal">
            ...
            <div>
              <div id="step-1">
                <form id="formstep1" class="panel" action="<?php echo e(url('sisfoh/save1')); ?>" method="POST">
                      ...
                      <div class="form-group row">
                          ...
                          <select class="form-control" id="selectDepartamento" name="iddepartamento">
                            ...
                            <?php $__currentLoopData = $departamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departamento): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <option value="<?php echo e($departamento->iddepa); ?>" 
                                    <?php if($departamento->iddepa == substr($ficha->idubigeo, 0,2)."0000"): ?> selected 
                                    <?php endif; ?>>
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12">
                          ...
                          <?php else: ?>
                            ...
                            <option value="<?php echo e($provincia->idprov); ?>"
                                <?php if($provincia->idprov == substr($ficha->idubigeo, 0,4)."00"): ?>
                                  selected <?php endif; ?>>
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12">
                          ...
                          <?php else: ?>
                            >
                            <option value="0">(Selecciona)</option>
                            <?php $__currentLoopData = $distritos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $distrito): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <option value="<?php echo e($distrito->iddist); ?>"
                                <?php if($distrito->iddist == $ficha->idubigeo): ?>
                                  selected <?php endif; ?>>
                        ...
                        <div class="col-md-6 col-sm-4 col-xs-12">
                          ...
                          <input type="text" class="form-control" value="<?php echo e($ficha->centropoblado); ?>" name="centropoblado" id="centropoblado">
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="panel-body">
                      <div class="form-group row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <?php $__currentLoopData = $tipovia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <span style="margin: 20px;">
                              <input type="radio"  name="tipovia" id="tipovia" 
                                    value="<?php echo e($tipo['codigo']); ?>"  required 
                                    <?php if($ficha->tipovia == $tipo['codigo']): ?> checked <?php endif; ?>
                                    /> 
                      ...
                      <div class="form-group row">
                        <div class="col-md-3 col-sm-4 col-xs-12">
                          ...
                          <input type="text" name="nombrevia" id="nombrevia" value="<?php echo e($ficha->nombrevia); ?>" class="form-control">
                        </div>
                        <div class="col-md-1 col-sm-2 col-xs-4">
                          <label for="">Número</label>
                          <input type="text" name="numeropuerta" id="numeropuerta" value="<?php echo e($ficha->numeropuerta); ?>" class="form-control">
                        </div>
                        <div class="col-md-1 col-sm-2 col-xs-4">
                          <label for="">Block</label>
                          <input type="text" name="block" id="block" value="<?php echo e($ficha->block); ?>" class="form-control">
                        </div>
                        <div class="col-md-1 col-sm-2 col-xs-4">
                          <label for="">Piso</label>
                          <input type="text" name="piso" id="piso" value="<?php echo e($ficha->piso); ?>" class="form-control">
                        </div>
                        <div class="col-md-1 col-sm-2 col-xs-4">
                          <label for="">Interior</label>
                          <input type="text" name="interior" id="interior" value="<?php echo e($ficha->interior); ?>" class="form-control">
                        </div>
                        <div class="col-md-1 col-sm-2 col-xs-4">
                          <label for="">Manzana</label>
                          <input type="text" name="manzana" id="manzana" value="<?php echo e($ficha->manzana); ?>" class="form-control">
                        </div>
                        <div class="col-md-1 col-sm-2 col-xs-4">
                          <label for="">Lote</label>
                          <input type="text" name="lote" id="lote" value="<?php echo e($ficha->lote); ?>" class="form-control">
                        </div>
                        <div class="col-md-1 col-sm-2 col-xs-4">
                          <label for="">Km</label>
                          <input type="text" name="kilometro" id="kilometro" value="<?php echo e($ficha->kilometro); ?>" class="form-control">
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <label for="">Teléfono</label>
                          <input type="text" name="telefono" id="telefono" value="<?php echo e($ficha->telefono); ?>" class="form-control">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div id="step-2">
                <form id="formstep2" class="panel" action="<?php echo e(url('sisfoh/save2')); ?>" method="POST">
                  <?php echo e(csrf_field()); ?>
                  ...
                  <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                      <div class="form-group row">
                        <?php $__currentLoopData = $lista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sublista): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                          <div class="col-md-4 col-sm-4 col-xs-6">
                            <div class="form-group">
                              <label style="height: 3em;margin-top: 1em;"><?php echo e($sublista["titulo"]); ?></label>
                              <select id="<?php echo e($sublista['idselect']); ?>" name="<?php echo e($sublista['name']); ?>" class="form-control">
                                <?php $__currentLoopData = $sublista['lista']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <option value="<?php echo e($item['codigo']); ?>"
                                    <?php if(
                              ...
                              <?php if(strcmp($sublista['idtext'],'') !== 0): ?>
                              <input type="text" style="margin-top: 5px;" id="<?php echo e($sublista['idtext']); ?>" name="<?php echo e($sublista['name'].'otro'); ?>"  class="form-control" name="" placeholder="Otro..."
                              <?php if($sublista['name'] == "tipovivienda" && strcmp($ficha->tipoviviendaotro,'')): ?> value='<?php echo e($ficha->tipoviviendaotro); ?>'
                              <?php elseif($sublista['name'] == "suviviendaes" && strcmp($ficha->suviviendaesotro,'')): ?> value='<?php echo e($ficha->suviviendaesotro); ?>'
                              <?php elseif($sublista['name'] == "materialparedes" && strcmp($ficha->materialparedesotro,'')): ?> value='<?php echo e($ficha->materialparedesotro); ?>'
                              <?php elseif($sublista['name'] == "materialtecho" && strcmp($ficha->materialtechootro,'')): ?> value='<?php echo e($ficha->materialtechootro); ?>'
                              <?php elseif($sublista['name'] == "materialpiso" && strcmp($ficha->materialpisootro,'')): ?> value='<?php echo e($ficha->materialpisootro); ?>'
                              <?php elseif($sublista['name'] == "tipoalumrado" && strcmp($ficha->tipoalumradootro,'')): ?> value='<?php echo e($ficha->tipoalumradootro); ?>'
                              <?php elseif($sublista['name'] == "abastecimientoagua" && strcmp($ficha->abastecimientoaguaotro,'')): ?> value='<?php echo e($ficha->abastecimientoaguaotro); ?>' 
                              <?php else: ?>
                                disabled="true"
                              <?php endif; ?>
                              '>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-6">
                          <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-sm-4">
                                <input type="number" name="numberHorasDemoraLlegar" id="numberHorasDemoraLlegar" min="0" max="24" name="" class="form-control" value="<?php echo e($ficha->demorallegarhoras); ?>">
                                <center>
                              ...
                              <div class="col-sm-8" style="margin-bottom: 20px;">
                                <a class="btn btn-warning btn-xs"  id="btnHorasDemoraLlegar" 
                                  ...
                                  <?php if($ficha->demorallegar == 1 || $ficha->demorallegar == 2): ?>  <?php else: ?> display: none; <?php endif; ?>">
                                  <span class="glyphicon glyphicon-time" aria-hidden="true"></span>
                                </a>
                                <small>(Si es menor a una hora anote 0)</small>
                              </div>
                              <div class="col-sm-12">
                                <input type="radio" name="radioHorasDemoraLlegar" value="1" <?php if($ficha->demorallegar == 1): ?> checked <?php endif; ?>> Más de 24 horas<br>

                                <input type="radio" name="radioHorasDemoraLlegar" value="2"  <?php if($ficha->demorallegar == 2): ?> checked <?php endif; ?>> Vive en la capital distrital
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div id="step-3">
                <form id="formstep3" class="panel" action="<?php echo e(url('sisfoh/save3')); ?>" method="POST">
                  <?php echo e(csrf_field()); ?>
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group row">
                          ...
                          <div class="col-xs-4 col-sm-2 col-md-2">
                            <input type="number" class="form-control" max="100" min="1" value="<?php echo e($ficha->cantidadhabitaciones); ?>" name="cantidadhabitaciones" id="cantidadhabitaciones">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group row">
                          ...
                          <div class="col-md-3">
                            <select id="selectCombustibleMasUsado" class="form-control" name="combustible" id="combustible">
                              ...
                              <option value="1" <?php if($ficha->combustible == 1): ?> selected <?php endif; ?>>¿Electricidad?</option>
                              <option value="2" <?php if($ficha->combustible == 2): ?> selected <?php endif; ?>>¿Gas?</option>
                              <option value="3" <?php if($ficha->combustible == 3): ?> selected <?php endif; ?>>¿Kerosene?</option>
                              <option value="4" <?php if($ficha->combustible == 4): ?> selected <?php endif; ?>>¿Carbón?</option>
                              <option value="5" <?php if($ficha->combustible == 5): ?> selected <?php endif; ?>>¿Leña?</option>
                              <option value="6" <?php if($ficha->combustible == 6): ?> selected <?php endif; ?>>¿Bosta o estiercol?</option>
                              <option value="7" <?php if($ficha->combustible == 7): ?> selected <?php endif; ?>>Otro (Especifique)</option>
                              <option value="8" <?php if($ficha->combustible == 8): ?> selected <?php endif; ?>>NO TIENE</option>
                            </select>
                          </div>
                          <div class="col-md-3">
                            <input type="text" id="txtCombustibleMasUsado" disabled="true" class="form-control" name="combustibleotro" id="combustibleotro" placeholder="Otro..." value="<?php echo e($ficha->combustibleotro); ?>">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group row">
                          <div class="col-xs-3 col-sm-2 col-md-2">
                            <div class="form-group">
                              ...
                              <input type="number" id="canthombres" class="form-control"  
                                    ...
                                    value="<?php echo e($ficha->cantidadhombres); ?>" min="0" name="cantidadhombres">
                            </div>
                          </div>
                          ...
                          <div class="col-xs-3 col-sm-2 col-md-2">
                            ...
                            <input type="number" id="cantmujeres" 
                              ...
                              class="form-control" value="<?php echo e($ficha->cantidadmujeres); ?>" min="0" name="cantidadmujeres">
                          </div>
                          <div class="col-md-1"><br><center>=</center></div>
                          <div class="col-xs-3 col-sm-2 col-md-2">
                            <label>Total</label>
              ...
              <div id="step-4">
                <form id="formstep4" class="panel" action="<?php echo e(url('sisfoh/save4')); ?>" method="POST">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">
            ...
            <img class="loading-spin pull-right" style="display: none;" width="40px" src="<?php echo e(asset('images/loading.gif')); ?>">
          </h4>
        </div>
        <div class="modal-body">
          <form id="frmPoblacion" action="<?php echo e(url('poblacion/save')); ?>" class="form-horizontal form-label-left">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" id="btnAgregarPersona" onclick="savePoblacion()">
            ...
            <img class="loading-spin" style="display: none;" width="30px" src="<?php echo e(asset('images/loading.gif')); ?>">Guardar
          </button>
        </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <!-- jQuery Smart Wizard -->
    <script src="<?php echo e(asset('js/jquery.smartWizardsisfoh.js')); ?>"></script>
    <!-- iCheck -->
    ...
    <script src="<?php echo e(asset('js/myjs/sisfoh.js')); ?>"></script>
