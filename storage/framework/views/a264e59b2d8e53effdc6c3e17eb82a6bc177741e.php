<?php $__env->startSection('title', 'RESULTADOS DEL EXAMEN GENERAL'); ?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          ...
          <br> <br>
          <div class="col-md-2">
            <button><a href="<?php echo e(url('llenar-respuestas-2020-2-CFM')); ?>">Proceso de Calificación</a></button>
          </div>
...
<script src="<?php echo e(asset('js/myjs/rep-postulante-calificacion-2020-2-CFM.js')); ?>"></script>
<script>
