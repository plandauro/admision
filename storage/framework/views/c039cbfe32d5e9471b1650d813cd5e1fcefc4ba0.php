        ...
        <div class="jumbotron">
          <div class="row">
            ...
            <div style="padding-right: 100px;margin-top: 0px;" class="col-xs-12 col-md-12">
              ...
              <div class="prueba2">
                <p style="font-weight:bold; aling:center;   width: 600px;   font-size: 15px; "> AGENTE: 25-122-01-<?php echo e($dni); ?> (PAGO PREFERENCIAL)</p>
              </div>
              <div class="prueba2">
                <p style="font-weight:bold; aling:center;"> VENTANILLA : 05-122-01-<?php echo e($dni); ?></p>
              </div>
              </p>
            </div>
