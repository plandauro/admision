...
<?php $__env->startSection('title', 'RESULTADOS DEL EXAMEN DEL CEPRE 2019-I'); ?>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <h2>Reporte de Calificacion CEPRE FINAL</h2>
...
<?php $__env->startSection('js'); ?>
  ...
  <script src="<?php echo e(asset('js/myjs/rep-postulante-calificacion-Cepre-Final.js')); ?>"></script>
<?php $__env->stopSection(); ?>
