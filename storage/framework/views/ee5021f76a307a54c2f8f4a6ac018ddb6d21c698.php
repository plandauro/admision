...
<body>
	...
	<table style="border: 0px;">
		<tr>
			...
			<td style="width: 80px; font-size: 18px; border: 2px solid #000; text-align: center;"><strong> <?php echo e(str_pad($postulacion->id, 6, "0", STR_PAD_LEFT)); ?></strong></td>
	...
	<table class="table">
		...
		<tr>
			...
			<td align="center"><strong><?php echo e(strtoupper($postulante->madre)); ?></strong>