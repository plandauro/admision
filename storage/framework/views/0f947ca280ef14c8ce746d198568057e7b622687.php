  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel2">Vacantes</h4>
      </div>
            ...
            <div class="form-group">
              ...
              <option value="">Seleccione</option>
                <?php $__currentLoopData = $ambiente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ambiente): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  <option value="<?php echo e($ambiente->CODIGOAMBIENTE); ?>"><?php echo e($ambiente->DESCRIPCIONAMBIENTE); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
              </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9 col-sm-9 col-xs-12">
                <select id="txtestado" class="form-control" name="txtestado" required="">
                  <option value="">Seleccione</option>
                  <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estados): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  <option value="<?php echo e($estados->CODIGOPARAMETRODETALLE); ?>"><?php echo e($estados->DESCRIPCION); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                </select>
              </div>
            </div>
