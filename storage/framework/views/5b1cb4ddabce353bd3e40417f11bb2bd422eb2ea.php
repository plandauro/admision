...
<?php $__env->startSection('title', 'REPORTE DE CALIFICACION ASISTENCIA - CANALES - HR'); ?>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <h2>Reporte de asistencia - HOJA DE RESPUESTAS - Canal </h2>
...
<div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label col-md-5 col-sm-5 col-xs-12">CANAL ADMISION:</label>
              <div class="col-md-7 col-sm-7 col-xs-12">
...
<?php $__env->startSection('js'); ?>
  ...
  <script src="<?php echo e(asset('js/myjs/rep-postulante-calificacion-Simulacro-Canales-HR.js')); ?>"></script>
<?php $__env->stopSection(); ?>
