  ...
  <div class="">
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Reporte de Calificacion Canal C</h2>
                        <br>     <br>                   
            <div class="col-md-2">
			<button><a  href="<?php echo e(url('llenar-respuestas-2020-2_canal_C')); ?>">Proceso de Calificación</a></button>
		</div>
            ...
            <ul class="nav navbar-right panel_toolbox">
              ...
              <li style="margin-right: 15px">
                <select style="width: 200px" id="tipobusqueda" onchange="cargarCombo()" class="form-control" name="" id="">
                  <option value="0">Postulantes Canal C</option>
                  <option value="23">Por escuela</option>
                </select>
              </li>
              <li>
...
<?php $__env->startSection('js'); ?>
  ...
  <script src="<?php echo e(asset('js/myjs/rep-postulante-calificacion-2020-2_canal_C.js')); ?>"></script>
  <script>
	...
	$.ajax({ 
	type: "POST", 
	url: 'rep-calificacion-2020-2_canal_C', 
