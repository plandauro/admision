<?php $__env->startSection('title', 'RESULTADOS DEL EXAMEN ESPECIAL 2020-II'); ?>
...
<div class="">
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Reporte de Examen Especial</h2>
          <br> <br>
          <div class="col-md-2">
            <button><a href="<?php echo e(url('llenar-respuestas-2020-2_especial')); ?>">Proceso de Calificación</a></button>
          </div>
...
<script src="<?php echo e(asset('js/myjs/rep-postulante-calificacion-2020-2_especial.js')); ?>"></script>
<script>
