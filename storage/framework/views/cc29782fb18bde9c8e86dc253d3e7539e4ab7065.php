  ...
  <div class="">
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Reporte de Calificacion Canal A</h2>
                        <br>     <br>                   
            <div class="col-md-2">
			<button><a  href="<?php echo e(url('llenar-respuestas-2020-2_canal_A')); ?>">Proceso de Calificación</a></button>
		</div>
...
<?php $__env->startSection('js'); ?>
  ...
  <script src="<?php echo e(asset('js/myjs/rep-postulante-calificacion-2020-2_canal_A.js')); ?>"></script>
  <script>
	...
	$.ajax({ 
	type: "POST", 
	url: 'rep-calificacion-2020-2_canal_A', 
