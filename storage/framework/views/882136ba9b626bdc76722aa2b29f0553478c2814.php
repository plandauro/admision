                ...
                <div class="panel-body">
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select name="medioseentero" id="medioseentero" class="form-control">
                      <option value="0">(Seleccionar)</option>
                      <?php $__currentLoopData = $encuesta1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $encuesta1x): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                      <option value="<?php echo e($encuesta1x->id); ?>"><?php echo e($encuesta1x->descripcion); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                    </select>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select name="dondesepreparo" id="dondesepreparo" class="form-control">
                      <option value="0">(Seleccionar)</option>
                      <?php $__currentLoopData = $encuesta2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $encuesta2x): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                      <option value="<?php echo e($encuesta2x->id); ?>"><?php echo e($encuesta2x->descripcion); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                    </select>
                  </div>
                </div>
...
<script src="<?php echo e(asset('js/myjs/verificarpostulacion.js')); ?>"></script>
<script src="<?php echo e(asset('js/myjs/ubigeo.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_except(get_def