        ...
        <div class="jumbotron">
          <div class="row">
            ...
            <div class="col-xs-12 col-md-12" style="padding: 0px 0px 0px 10px;" >
              ...
              <li>
                  <a id="link" href="<?php echo e(url('/pdf/ficha_inscripcion')); ?>" target="_blank">
  ...
  <div class="">
          ...
          <div class="row">
            ...
            <!-- <div class="col-xs-12 col-md-12" style="padding: 0px 0px 0px 10px;" >
              ...
              <li>
                ...
                <li>
                  <a id="link2"  href="<?php echo e(url('/pdf/jdantecedentes_inscripcion')); ?>" target="_blank">
    ...
    <center>
              <a id="idfinalizar2" style="font-size: 16px; 
                              ...
                              padding: 10px;
                              border-radius: 15px;
                              cursor: pointer;" href="<?php echo e(url('/finalizar')); ?>">Finalizar Postulación</a>
              </center> 
