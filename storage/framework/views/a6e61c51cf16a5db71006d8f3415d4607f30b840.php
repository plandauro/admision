  ...
  function fileValidation2(){
    ...
    $(document).on("submit",".formarchivo1",function(e){
  	fileValidation2();
        ...
        //if(nombreform=="f_subir_imagen" ){ var miurl="subir_imagen_usuario";  var divresul="notificacion_resul_fci"}
        if(nombreform=="f_cargar_datos_usuarios1" ){ var miurl="cargar-txt1";  var divresul="notificacion_resul_fcdu"}
...
//        alert('ENTRO');
		...
		$("#archivo2").val("");
	        ...
	        $("#message21").text("Se cargo correctamente TOTAL: "+data.total); 
  ...
  function fileValidation3(){
    ...
    $(document).on("submit",".formarchivo2",function(e){
  	fileValidation3();
        ...
        //if(nombreform=="f_subir_imagen" ){ var miurl="subir_imagen_usuario";  var divresul="notificacion_resul_fci"}
        if(nombreform=="f_cargar_datos_usuarios2" ){ var miurl="cargar-txt2";  var divresul="notificacion_resul_fcdu"}
...
function fileValidation4(){
    ...
    $(document).on("submit",".formarchivo3",function(e){
  	fileValidation4();
        ...
        //if(nombreform=="f_subir_imagen" ){ var miurl="subir_imagen_usuario";  var divresul="notificacion_resul_fci"}
        if(nombreform=="f_cargar_datos_usuarios3" ){ var miurl="cargar-txt3";  var divresul="notificacion_resul_fcdu"}
