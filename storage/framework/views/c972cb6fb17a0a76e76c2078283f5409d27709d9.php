...
<body style="background:url(images/FORMATO-DE-CONSTANCIA-2019.jpg);">
	<?php
		$mes ="";
		switch (date("n")) {
	...
	<div class="constancia">
		<table width="100%">
			<tr>
				...
				<td align="center">
					...
					RESOLUCIÓN DE COMISIÓN ORGANIZADORA N° 306-2018-UNAB (APROBACIÓN DEL PROCESO DE ADMISIÓN 2019-I) <br>
		...
		<p style="text-align: center; font-weight: bold;font-size: 18px; margin: 20px 0px 0px 0px;">BARRANCA, 12 ABRIL <?php echo e(date("Y")); ?></p>
<br><br><br><br><br><br>
		<div id="firma">
			<span style="font-size: 16px;"><?php echo e($postulacion->responsable); ?></span> <br>
			<span>DIRECTOR DE ADMISIÓN</span><br>
		</div>
