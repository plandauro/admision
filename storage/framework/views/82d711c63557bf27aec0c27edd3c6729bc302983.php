  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Inscripción de Postulación</h3>
      </div>
                ...
                <form class="form-horizontal form-label-left panel">
                        ...
                        <div class="row">
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-7 col-sm-7 col-xs-12">
                                <input type="text" class="form-control" id="apepaterno" value="<?php echo e(Auth::user()->apepaterno); ?>" name="apepaterno">
                              </div>
                            </div>
                            <!-- input -->
                            <div class="form-group">
                              ...
                              <div class="col-md-7 col-sm-7 col-xs-12">
                                <input type="text" class="form-control col-md-7 col-xs-12" value="<?php echo e(Auth::user()->apematerno); ?>" id="apematerno" name="apematerno">
                              </div>
                            </div>
                            <!-- input -->
                            <div class="form-group">
                              ...
                              <div class="col-md-7 col-sm-7 col-xs-12">
                                <input type="text" class="form-control col-md-7 col-xs-12" value="<?php echo e(Auth::user()->nombre); ?>" id="nombre" name="nombre">
                              </div>
                            </div>
                            <!-- input -->
                            <div class="form-group">
                              ...
                              <div class="col-md-7 col-sm-7 col-xs-12">
                                <p style="margin: 7px 0px 7px 0px">
                                  <span style="margin-right: 10px;">
                                      <input type="radio" class="inputsexo"  id="sexoM" name="sexo" value="M" <?php if(Auth::user()->sexo == "M"): ?> checked <?php endif; ?> />
                                       Hombre 
                                  </span>
                                  <span>
                                      <input type="radio" class="inputsexo"  id="sexoF" name="sexo" value="F" <?php if(Auth::user()->sexo == "F"): ?> checked <?php endif; ?>  />
                                      Mujer
                                  </span>
                                </p>
                              </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-7 col-sm-7 col-xs-12">
                                <input type="text" id="dni" max="8" min="8" value="<?php echo e(Auth::user()->dni); ?>" name="dni" class="form-control col-md-7 col-xs-12" <?php if(!Auth::user()->tipodocumento): ?> disabled <?php endif; ?>>
                              </div>
                            </div>
                            <!-- input -->
                            <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-7 col-sm-7 col-xs-12">
                                <input type="date" class="form-control has-feedback-left"  id="fechanacimiento" name="fechanacimiento" aria-describedby="inputSuccess2Status2" value="<?php echo e(Auth::user()->fechanacimiento); ?>">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-7 col-sm-7 col-xs-12">
                                <p style="margin: 7px 0px 7px 0px">
                                  <span style="margin-right: 10px;">
                                    <input type="radio" class="rbextrangero" id="extranjerosi" name="extranjero" value="1" <?php echo e($nacimientoextranjero? 'checked': ''); ?> />
                                    SI
                                  </span>
                                  <span>
                                    <input type="radio" class="rbextrangero" id="extranjerono" name="extranjero" value="0" <?php echo e(!$nacimientoextranjero? 'checked': ''); ?> />
                                    NO
                                  </span>
                                </p>
                              </div>
                            ...
                            <div class="form-group extranjero" <?php echo e($nacimientoextranjero? '': 'style=display:none'); ?> >
                              <label class="control-label col-md-5 col-sm-5 col-xs-12" for="">País*</small></label>
                              <div class="col-md-7 col-sm-7 col-xs-12">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <div align="center" class="image-upload">
                                        <label id="img-btn" data-toggle="modal" data-target=".bs-example-modal-sm" style="cursor: pointer;">
                                            ...
                                            <?php else: ?>
                                              src="<?php echo e(asset('images/').Auth::user()->foto); ?>"/>
                                            <?php endif; ?>
                    ...
                    <div class="panel-body">
                      <div class="form-group row">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12">
                          ...
                          <input type="text" name="direccion" id="direccion" value="<?php echo e(Auth::user()->direccion); ?>" class="form-control">
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <label for="">Número *</label>
                          <input type="text" name="numero" id="numero" value="<?php echo e(Auth::user()->numero); ?>" class="form-control">
                        </div>
                    ...
                    <div class="panel-body">
                      <div class="form-group row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" name="padre" id="padre" value="<?php echo e(Auth::user()->padre); ?>" class="form-control">
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label for="">Apellidos y nombres de la Madre *</label>
                          <input type="text" name="madre" id="madre" value="<?php echo e(Auth::user()->madre); ?>" class="form-control">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="form-group row ">
                        <div class="col-xs-12">
                          <input type="checkbox" id="colegioextranjero" name="colegioextranjero" value="1" <?php echo e($colegioextranjero? "checked":""); ?> ><strong> Estudió en Colegio Extranjero</strong>
                        </div>
                      </div>
                      <div class="form-group row colegiooubigeo" <?php echo e($colegioextranjero? 'style=display:none':""); ?> >
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          ...
                          <select class="form-control" id="iddepartamentocolegio" name="iddepartamentocolegio">
                            ...
                            <?php $__currentLoopData = $departamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departamento): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                               <option value="<?php echo e($departamento->iddepa); ?>" 
                                    <?php if($ie != ""): ?>
                                      <?php if($departamento->iddepa == substr($ie->idubigeo, 0,2)."0000"): ?> selected <?php endif; ?>
                                    <?php endif; ?>
                                >
                                  <?php echo e($departamento->departamento); ?>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          ...
                          <select class="form-control" id="idprovinciacolegio" name="idprovinciacolegio" 
                            ...
                            >
                              ...
                              <option value="<?php echo e($provincia->idprov); ?>"
                                <?php if($provincia->idprov == substr($ie->idubigeo, 0,4)."00"): ?>
                                  selected <?php endif; ?>>
                                  <?php echo e($provincia->provincia); ?>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          ...
                          <select class="form-control" id="iddistritocolegio" name="iddistritocolegio"
                            ...
                            <option value="<?php echo e($distrito->iddist); ?>"
                                <?php if($distrito->iddist == $ie->idubigeo): ?>
                                  selected <?php endif; ?>>
                              <?php echo e($distrito->distrito); ?>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 colegioextranjero"  <?php echo e($colegioextranjero? "":"style=display:none"); ?> >
                          ...
                          <input type="text" class="form-control" name="nombreie" id="nombreie" value="<?php echo e(Auth::user()->nombreie); ?>">
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12 colegioextranjero"  <?php echo e($colegioextranjero? "":"style=display:none"); ?> >
                          ...
                          <p style="margin: 7px 0px 7px 0px">
                            ...
                            <span>
                                <input type="radio" class="inputtipocolegio"  id="colegio" name="estatal" value="0" <?php if(Auth::user()->estatal == 0): ?> checked <?php endif; ?>  />
                                Particular
                            </span>
                          </p>
                        </div>
                  ...
                  <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <select name="idtarifa" id="" class="form-control">
                          <option value="0">(Seleccionar)</option>
                ...
                <form class="form-horizontal form-label-left panel">
                  <div class="jumbotron">
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <ul id="lista-link">
                          <li><a onclick="alert('Descargando archivo...');"><span class="fa fa-file-pdf-o"></span> 1. Solicitud de inscripción</a></li>
                          <li><a><span class="fa fa-file-pdf-o"></span> 2. Ficha de Inscripción</a></li>
                          <li><a><span class="fa fa-file-pdf-o"></span> 3. Declaración Jurada de conocer y cumplir el Reglamento General de Admisión</a></li>
                          <li><a><span class="fa fa-file-pdf-o"></span> 4. Declaración Jurada de Antecedentes Penales</a></li>
                          <li><a><span class="fa fa-file-pdf-o"></span> 5. Declaración Jurada de haber concluido Satisfactoriamente Estudios Secundarios</a></li>
                        </ul>
                        <style type="text/css">
                          #lista-link li{
                            list-style:none;
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <form enctype="multipart/form-data" id="form-foto" method="post">
                            ...
                            <!--<input type="file" id="file-input" class="btn btn-default" accept="image/*" name="foto" />-->
                            ...
                            <button id="btnrecortar" disabled="true" class="btn btn-default">Recortar</button>
                          </form>
                        </div>
  ...
  <script type="text/javascript">
    ...
    $fileinput.change(function() {
      if (this.files && this.files[0]) {
        ...
        $imginput.attr('src', "<?php echo e(asset('images/user.png')); ?>");
        $btnGuardar.prop('disabled', true);
        $btnrecortar.prop('disabled', true);
      }
    });

    $btnrecortar.click(function(e) {
      e.preventDefault();
      $imginput.Jcrop({
        setSelect: [ 25,25,250,250 ],
        aspectRatio: 1,
