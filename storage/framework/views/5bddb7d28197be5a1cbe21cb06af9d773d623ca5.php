...
<?php $__env->startSection('title', 'RESULTADOS DEL SIMULACRO DEL EXAMEN DE ADMISIÓN 2018-II'); ?>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <h2>Reporte de Calificacion Simulacro</h2>
                        <br>     <br>                   
            <div class="col-md-2">
			<button><a  href="<?php echo e(url('llenar-respuestas-simulacro')); ?>">Proceso de Calificación Simulacro</a></button>
		</div>    
            ...
            <ul class="nav navbar-right panel_toolbox">
              ...
              <li>
                <select id="dato" style="width: 300px" onchange="consultaProducto()" disabled="true" class="form-control" name="" id="">
...
<?php $__env->startSection('js'); ?>
  ...
  <script src="<?php echo e(asset('js/myjs/rep-postulante-calificacion-simulacro.js')); ?>"></script>
  <script>
