<?php $__env->startSection('title', 'Reporte de Padron de Postulantes'); ?>
  ...
  <div class="">
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Reporte de Padron Postulantes</h2>
...
<?php $__env->startSection('js'); ?>
  ...
  <script src="<?php echo e(asset('js/myjs/rep-padron-postulantes.js')); ?>"></script>
<?php $__env->stopSection(); ?>
