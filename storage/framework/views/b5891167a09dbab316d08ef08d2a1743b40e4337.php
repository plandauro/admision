...
<?php $__env->startSection('title', 'Reporte de Postulantes '); ?>
            ...
            <ul class="nav navbar-right panel_toolbox">
              ...
              <li style="margin-right: 15px">
                <select style="width: 200px" id="tipobusqueda" onchange="cargarCombo()" class="form-control" name="" id="">
                  ...
                  <option value="3">Por modalidad</option>
                  <option value="4">Por área</option>
                </select>
              </li>
              <li>
...
<script src="<?php echo e(asset('js/jquery.dataTables.min.js')); ?>"></script>
 ...
 <script src="<?php echo e(asset('js/buttons.print.min.js')); ?>"></script>
  <script src="<?php echo e(asset('js/myjs/rep-postulante.js')); ?>"></script>
<?php $__env->stopSection(); ?>
