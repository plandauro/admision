      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <h2>Mantenimiento de Preguntas No Usadas</h2>
              ...
              <button id="btnEliminar"  type="button" class="navbar-right btn btn-danger"  >
                <span class="fa fa-times-circle"></span> Usar la pregunta
              </button>
              </li>
            </ul>
...
<br>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9 col-sm-9 col-xs-12">
                <input id="ac" name="ac" onkeyup="mayus(this);" type="text" class="form-control">
              </div>
            </div>
...
<?php $__env->startSection('js'); ?>
  ...
  <script src="<?php echo e(asset('js/myjs/preguntas.js')); ?>"></script>
<?php $__env->stopSection(); ?>
