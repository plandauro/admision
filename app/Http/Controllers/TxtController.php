...
class TxtController extends Controller
{
    ...
    /*** INICIO - PROCESO INGENIERIA AGRONOMA ***/
        /* CARGAR TXT INGENIERIA AGRONOMA */
        public function cargarInformacion20202IA()
        {
            if (!Proceso::abierto())
                return redirect("/");
            //return view("cargartxt-2020-2");
            $procesos = Proceso::orderBy('id', 'desc')->get();
            return view('cargartxt-2020-2-IA')->with('procesos', $procesos);
        }

        public function cargarInformacionTXT20202IA(Request $request)
        {
        ...
        public function cargarInformacionTXT120202IA(Request $request)
        {
        ...
        public function cargarInformacionTXT220202IA(Request $request)
        {
        ...
        public function cargarInformacionTXT320202IA(Request $request)
        {
        ...
        /* PARA DUPLICADOS 2020 II - INGENIERIA AGRONOMA */
        public function postulantesDuplicados20202IA()
        {
            $procesos = Proceso::orderBy('id', 'desc')->get();
        ...
        public function listPostulatesDuplicados20202IA(Request $request)
        {
            $postulacion = null;
            if ($request->dato == 0)
                $request->tipo = 0;
        ...
        /* ACTUALIZAR DUPLICADOS 2020-II-INGENIERIA AGRONOMA*/
        public function actualizarAdmisionDuplicado20202IA(Request $request)
        {
        ...
        public function postulantes20202IA()
        {
            $procesos = Proceso::orderBy('id', 'desc')->get();
            return view('calificacion_2020_2-IA')->with("procesos", $procesos);
        }

        public function listPostulates20202IA(Request $request)
        {
            $postulacion = null;
            if ($request->dato == 0)
                $request->tipo = 0;
        ...
        /* PROCESO RESPUESTA - INGENIERIA AGRONOMA */
    ...
    /*** FIN - PROCESO INGENIERIA AGRONOMA ***/

    /*** INICIO - PROCESO INGENIERIA EN INDUSTRIAS ALIMENTARIAS ***/
        /* CARGAR TXT INGENIERIA EN INDUSTRIAS ALIMENTARIAS */
        public function cargarInformacion20202IIA()
        {
            if (!Proceso::abierto())
                return redirect("/");
            //return view("cargartxt-2020-2");
        ...
        public function cargarInformacionTXT20202IIA(Request $request)
        {
        ...
        public function cargarInformacionTXT120202IIA(Request $request)
        {
        ...
        public function cargarInformacionTXT220202IIA(Request $request)
        {
        ...
        public function cargarInformacionTXT320202IIA(Request $request)
        {
        ...
        /* PARA DUPLICADOS 2020 II - INGENIERIA EN INDUSTRIAS ALIMENTARIAS */
        public function postulantesDuplicados20202IIA()
        {
            $procesos = Proceso::orderBy('id', 'desc')->get();
        ...
        /* PROCESO RESPUESTA - INGENIERIA EN INDUSTRIAS ALIMENTARIAS */
    ...
    /*** INICIO - PROCESO INGENIERIA CIVIL TURNO MAÑANA ***/
        ...
        public function cargarInformacionTXT120202ICM(Request $request)
        {
        ...
        public function cargarInformacionTXT220202ICM(Request $request)
        {
        ...
        public function cargarInformacionTXT320202ICM(Request $request)
        {
    ...
    /*** INICIO - PROCESO DERECHO Y CIENCIAS TURNO MAÑANA ***/
        ...
        public function actualizarAdmisionCanal20202DCM(Request $request)
        {
         ...
         public function listPostulates20202DCM(Request $request)
         {
             ...
             switch ($request->tipo) {
                 ...
                 default:
                     ...
                     //$postulaciones=(DB :: select( DB :: raw ("call sp_calificar_admision()")));
                     $postulaciones = (DB::select(DB::raw("call sp_calificar_proceso_2020_2_canal_C_group1()")));
         ...
         public function procesoRespuesta20202DCM()
         {
             ...
             DB::statement('call sp_insercion_calificar_proceso_2020_2_canal_C_group1()');
    ...
    /*** INICIO - PROCESO DERECHO Y CIENCIAS TURNO TARDE ***/
        /* CARGAR TXT DERECHO Y CIENCIAS TURNO TARDE */
        public function cargarInformacion20202DCT()
        {
            if (!Proceso::abierto())
                return redirect("/");
            //return view("cargartxt-2020-2");
            $procesos = Proceso::orderBy('id', 'desc')->get();
            return view('cargartxt-2020-2-DCT')->with('procesos', $procesos);
        }

        public function cargarInformacionTXT20202DCT(Request $request)
        {
        ...
        public function cargarInformacionTXT120202DCT(Request $request)
        {
        ...
        public function cargarInformacionTXT220202DCT(Request $request)
        {
        ...
        public function cargarInformacionTXT320202DCT(Request $request)
        {
        ...
        /* PARA DUPLICADOS 2020 II - DERECHO Y CIENCIAS TURNO TARDE */
        public function postulantesDuplicados20202DCT()
        {
            $procesos = Proceso::orderBy('id', 'desc')->get();

            return view('calificacionDuplicados-2020-2-DCT')->with("procesos", $procesos);
        }

        public function listPostulatesDuplicados20202DCT(Request $request)
        {
            $postulacion = null;
            if ($request->dato == 0)
                $request->tipo = 0;
        ...
        /* ACTUALIZAR DUPLICADOS 2020-II-DERECHO Y CIENCIAS TURNO TARDE */
        public function actualizarAdmisionDuplicado20202DCT(Request $request)
        {
        ...
        public function actualizarAdmisionCanal20202DCT(Request $request)
        {
         ...
         /* CALIFICACION - DERECHO Y CIENCIAS TURNO TARDE */
         public function postulantes20202DCT()
         {
             $procesos = Proceso::orderBy('id', 'desc')->get();
             return view('calificacion_2020_2-DCT')->with("procesos", $procesos);
         }
 
         public function listPostulates20202DCT(Request $request)
         {
             $postulacion = null;
             if ($request->dato == 0)
                 $request->tipo = 0;
             switch ($request->tipo) {
                 ...
                 default:
                     ...
                     //$postulaciones=(DB :: select( DB :: raw ("call sp_calificar_admision()")));
                     $postulaciones = (DB::select(DB::raw("call sp_calificar_proceso_2020_2_canal_C_group2()")));
         ...
         /* PROCESO RESPUESTA - DERECHO Y CIENCIAS TURNO TARDE */
         public function procesoRespuesta20202DCT()
         {
 
             DB::statement('call sp_insercion_calificar_proceso_2020_2_canal_C_group2()');
 
             return redirect('rep-calificacion-2020-2-DCT'); //CALIFICACION 2020 - 2
 
             // return redirect('rep-calificacion');	//ALIFICACION ANTIGUA
 
         }
    /*** FIN - PROCESO DERECHO Y CIENCIAS TURNO TARDE ***/

    /*** INICIO - PROCESO CONTABILIDAD Y FINANZAS TURNO MAÑANA ***/
        /* CARGAR TXT CONTABILIDAD Y FINANZAS TURNO MAÑANAE */
        public function cargarInformacion20202CFM()
        {
            if (!Proceso::abierto())
                return redirect("/");
            //return view("cargartxt-2020-2");
            $procesos = Proceso::orderBy('id', 'desc')->get();
            return view('cargartxt-2020-2-CFM')->with('procesos', $procesos);
        }

        public function cargarInformacionTXT20202CFM(Request $request)
        {
        ...
        public function cargarInformacionTXT120202CFM(Request $request)
        {
        ...
        public function cargarInformacionTXT220202CFM(Request $request)
        {
        ...
        public function cargarInformacionTXT320202CFM(Request $request)
        {
        ...
        /* PARA DUPLICADOS 2020 II - CONTABILIDAD Y FINANZAS TURNO MAÑANA */
        public function postulantesDuplicados20202CFM()
        {
            $procesos = Proceso::orderBy('id', 'desc')->get();

            return view('calificacionDuplicados-2020-2-CFM')->with("procesos", $procesos);
        }

        public function listPostulatesDuplicados20202CFM(Request $request)
        {
            $postulacion = null;
            if ($request->dato == 0)
                $request->tipo = 0;
        ...
        /* ACTUALIZAR DUPLICADOS 2020-II-CONTABILIDAD Y FINANZAS TURNO MAÑANA */
        public function actualizarAdmisionDuplicado20202CFM(Request $request)
        {
        ...
        public function actualizarAdmisionCanal20202CFM(Request $request)
        {
         ...
         /* CALIFICACION - CONTABILIDAD Y FINANZAS TURNO MAÑANA */
        public function postulantes20202CFM()
        {
             $procesos = Proceso::orderBy('id', 'desc')->get();
             return view('calificacion_2020_2-CFM')->with("procesos", $procesos);
        }
 
        public function listPostulates20202CFM(Request $request)
        {
             $postulacion = null;
             if ($request->dato == 0)
                 $request->tipo = 0;
             switch ($request->tipo) {
                 ...
                 default:
                     ...
                     //$postulaciones=(DB :: select( DB :: raw ("call sp_calificar_admision()")));
                     $postulaciones = (DB::select(DB::raw("call sp_calificar_proceso_2020_2_canal_D_group1()")));
         ...
         /* PROCESO RESPUESTA - DERECHO Y CIENCIAS TURNO MAÑANA */
        public function procesoRespuesta20202CFM()
        {
 
             DB::statement('call sp_insercion_calificar_proceso_2020_2_canal_D_group1()');
 
             return redirect('rep-calificacion-2020-2-CFM'); //CALIFICACION 2020 - 2
    ...
    /*** INICIO - PROCESO CONTABILIDAD Y FINANZAS TURNO TARDE ***/
        /* CARGAR TXT CONTABILIDAD Y FINANZAS TURNO TARDE */
        public function cargarInformacion20202CFT()
        {
            if (!Proceso::abierto())
                return redirect("/");
            //return view("cargartxt-2020-2");
            $procesos = Proceso::orderBy('id', 'desc')->get();
            return view('cargartxt-2020-2-CFT')->with('procesos', $procesos);
        }

        public function cargarInformacionTXT20202CFT(Request $request)
        {
        ...
        public function cargarInformacionTXT120202CFT(Request $request)
        {
        ...
        public function cargarInformacionTXT220202CFT(Request $request)
        {
        ...
        public function cargarInformacionTXT320202CFT(Request $request)
        {
        ...
        /* PARA DUPLICADOS 2020 II - CONTABILIDAD Y FINANZAS TURNO TARDE */
        public function postulantesDuplicados20202CFT()
        {
            $procesos = Proceso::orderBy('id', 'desc')->get();

            return view('calificacionDuplicados-2020-2-CFT')->with("procesos", $procesos);
        }

        public function listPostulatesDuplicados20202CFT(Request $request)
        {
            $postulacion = null;
            if ($request->dato == 0)
                $request->tipo = 0;
        ...
        /* ACTUALIZAR DUPLICADOS 2020-II-CONTABILIDAD Y FINANZAS TURNO TARDE */
        public function actualizarAdmisionDuplicado20202CFT(Request $request)
        {
        ...
        public function actualizarAdmisionCanal20202CFT(Request $request)
        {
        ...
        /* CALIFICACION - CONTABILIDAD Y FINANZAS TURNO TARDE */
        public function postulantes20202CFT()
        {
             $procesos = Proceso::orderBy('id', 'desc')->get();
             return view('calificacion_2020_2-CFT')->with("procesos", $procesos);
        }
 
        public function listPostulates20202CFT(Request $request)
        {
             $postulacion = null;
             if ($request->dato == 0)
                 $request->tipo = 0;
             switch ($request->tipo) {
                 ...
                 default:
                     ...
                     //$postulaciones=(DB :: select( DB :: raw ("call sp_calificar_admision()")));
                     $postulaciones = (DB::select(DB::raw("call sp_calificar_proceso_2020_2_canal_D_group2()")));
        ...
        /* PROCESO RESPUESTA - CONTABILIDAD Y FINANZAS TURNO MAÑANA */
        public function procesoRespuesta20202CFT()
        {
 
             DB::statement('call sp_insercion_calificar_proceso_2020_2_canal_D_group2()');
 
             return redirect('rep-calificacion-2020-2-CFT'); //CALIFICACION 2020 - 2
 
             // return redirect('rep-calificacion');	//ALIFICACION ANTIGUA
 
        }
    /*** FIN - PROCESO CONTABILIDAD Y FINANZAS TURNO MAÑANA ***/

    /*** INICIO - PROCESO ENFERMERIA TURNO MAÑANA ***/
        /* CARGAR TXT ENFERMERIA TURNO MAÑANAE */
        public function cargarInformacion20202ENFM()
        {
            if (!Proceso::abierto())
                return redirect("/");
            //return view("cargartxt-2020-2");
            $procesos = Proceso::orderBy('id', 'desc')->get();
            return view('cargartxt-2020-2-ENFM')->with('procesos', $procesos);
        }

        public function cargarInformacionTXT20202ENFM(Request $request)
        {
        ...
        public function cargarInformacionTXT120202ENFM(Request $request)
        {
        ...
        public function cargarInformacionTXT220202ENFM(Request $request)
        {
        ...
        public function cargarInformacionTXT320202ENFM(Request $request)
        {
        ...
        /* PARA DUPLICADOS 2020 II - ENFERMERIA TURNO MAÑANA */
        public function postulantesDuplicados20202ENFM()
        {
            $procesos = Proceso::orderBy('id', 'desc')->get();

            return view('calificacionDuplicados-2020-2-ENFM')->with("procesos", $procesos);
        }

        public function listPostulatesDuplicados20202ENFM(Request $request)
        {
            $postulacion = null;
            if ($request->dato == 0)
                $request->tipo = 0;
        ...
        /* ACTUALIZAR DUPLICADOS 2020-II-ENFERMERIA TURNO MAÑANA */
        public function actualizarAdmisionDuplicado20202ENFM(Request $request)
        {
        ...
        public function actualizarAdmisionCanal20202ENFM(Request $request)
        {
        ...
        /* CALIFICACION - ENFERMERIA TURNO MAÑANA */
        public function postulantes20202ENFM()
        {
             $procesos = Proceso::orderBy('id', 'desc')->get();
             return view('calificacion_2020_2-ENFM')->with("procesos", $procesos);
        }
 
        public function listPostulates20202ENFM(Request $request)
        {
             $postulacion = null;
             if ($request->dato == 0)
                 $request->tipo = 0;
        ...
        /* PROCESO RESPUESTA - ENFERMERIA TURNO MAÑANA */
        public function procesoRespuesta20202ENFM()
        {
 
             DB::statement('call sp_insercion_calificar_proceso_2020_2_canal_B_group1()');
 
             return redirect('rep-calificacion-2020-2-ENFM'); //CALIFICACION 2020 - 2
    ...
    /*** INICIO - PROCESO OBSTETRICIA TURNO TARDE ***/
        ...
        public function cargarInformacion20202OBST()
        {
            ...
            //return view("cargartxt-2020-2");
            $procesos = Proceso::orderBy('id', 'desc')->get();
            return view('cargartxt-2020-2-OBST')->with('procesos', $procesos);
        }

        public function cargarInformacionTXT20202OBST(Request $request)
        {
        ...
        public function cargarInformacionTXT120202OBST(Request $request)
        {
        ...
        public function cargarInformacionTXT220202OBST(Request $request)
        {
        ...
        public function cargarInformacionTXT320202OBST(Request $request)
        {
        ...
        public function postulantesDuplicados20202OBST()
        {
            ...
            return view('calificacionDuplicados-2020-2-OBST')->with("procesos", $procesos);
        }

        public function listPostulatesDuplicados20202OBST(Request $request)
        {
            $postulacion = null;
            if ($request->dato == 0)
                $request->tipo = 0;
        ...
        public function actualizarAdmisionCanal20202OBST(Request $request)
        {
        ...
        {
             $procesos = Proceso::orderBy('id', 'desc')->get();
             return view('calificacion_2020_2-OBST')->with("procesos", $procesos);
        }
 
        public function listPostulates20202OBST(Request $request)
        {
             $postulacion = null;
             if ($request->dato == 0)
                 $request->tipo = 0;
             switch ($request->tipo) {
                 ...
                 default:
                     ...
                     //$postulaciones=(DB :: select( DB :: raw ("call sp_calificar_admision()")));
                     $postulaciones = (DB::select(DB::raw("call sp_calificar_proceso_2020_2_canal_B_group2()")));
        ...
        public function procesoRespuesta20202OBST()
        {
             ...
             DB::statement('call sp_insercion_calificar_proceso_2020_2_canal_B_group2()');
 
             return redirect('rep-calificacion-2020-2-OBST'); //CALIFICACION 2020 - 2
